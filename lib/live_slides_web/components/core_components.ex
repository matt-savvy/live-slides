defmodule LiveSlidesWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveSlidesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveSlidesWeb.Gettext, "errors", msg, opts)
    end
  end
